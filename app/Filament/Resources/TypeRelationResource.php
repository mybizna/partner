...
use Modules\Partner\Filament\Resources\TypeRelationResource\RelationManagers;
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('partner_id')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('partner_type_id')
                    ->required()
                    ->numeric(),
            ]);
    }
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('partner_id')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('partner_type_id')
                    ->numeric()
                    ->sortable(),
